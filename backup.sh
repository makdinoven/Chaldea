...
docker exec -i chaldea_mysql_1 mysqldump -u root -p$MYSQL_ROOT_PASSWORD --single-transaction --routines --triggers --complete-insert --extended-insert mydatabase > $BACKUP_FILE
