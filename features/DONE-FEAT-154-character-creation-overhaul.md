...
[LOG] 2026-09-06 — PM: PR #11 влит в main, деплой прошёл успешно; на проде проверены новые эндпоинты и применение миграций к боевой базе
[LOG] 2026-09-06 — Frontend Dev: пост-релизная полировка по замечаниям пользователя — карточка расы без подложки, «Мои заявки» свёрнуты в компактные карточки (35120 -> 2723 px на десктопе, 42402 -> 6869 px на мобильном), УР вынесен бейджем в шапку паспорта
[LOG] 2026-09-06 — PM: фича закрыта, файл переименован в DONE-
```
