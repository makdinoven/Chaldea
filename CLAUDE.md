...
- `docs/GAME-STATS.md` — геймдизайн: пресеты характеристик по подрасам, очки за уровень, за что отвечает каждый стат, базовые значения.
- `docs/GAME-SKILLS.md` — геймдизайн: какие поля заполняются при создании навыка и как их читает авто-бой.
