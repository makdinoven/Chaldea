"""
Tests for POST /photo/change_district_icon replacement behavior (FEAT-119).
...
NEW_URL = "https://s3.example.com/district_icons/new_icon.webp"
OLD_URL = "https://s3.example.com/district_icons/old_icon.webp"


class TestChangeDistrictIconReplacement:
    """FEAT-119 replacement behavior."""

    @patch("main.delete_s3_file")
    @patch("main.update_district_icon")
    @patch("main.get_district_map_icon_url", return_value=OLD_URL)
    ...
    @patch("main.delete_s3_file")
    @patch("main.update_district_icon")
    @patch("main.get_district_map_icon_url", return_value=None)
    @patch("main.upload_file_to_s3", return_value=NEW_URL)
    @patch("auth_http.requests.get")
