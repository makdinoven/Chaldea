...
export const createDistrict = createAsyncThunk(
    ...
    async (districtData, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.post('/locations/districts', districtData);
...
export const updateDistrict = createAsyncThunk(
    ...
    async ({ id, ...districtData }, { rejectWithValue }) => {
        try {
            const response = await axios.put(`/locations/districts/${id}/update`, districtData);
            return response.data;
        } catch (error) {
            return rejectWithValue(error.response?.data || error.message);
        }
...
export const fetchDistrictDetails = createAsyncThunk(
    ...
    async (districtId, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.get(`/locations/districts/${districtId}/details`);
...
export const deleteDistrict = createAsyncThunk(
    ...
    async (districtId, { rejectWithValue }) => {
        try {
            ...
            await axios.delete(`/locations/districts/${districtId}/delete`);
            return districtId;
        } catch (error) {
            return rejectWithValue(error.response?.data || error.message);
        }
