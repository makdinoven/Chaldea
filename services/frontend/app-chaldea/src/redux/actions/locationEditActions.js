...
export const createLocation = createAsyncThunk(
    ...
    async (locationData, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.post('/locations/', processedData);
...
export const updateLocation = createAsyncThunk(
    ...
    async (locationData, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.put(`/locations/${id}/update`, updateData);
            return response.data;
        } catch (error) {
...
export const updateLocationNeighbors = createAsyncThunk(
    ...
    async ({ locationId, neighbors }, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.post(
                `/locations/${locationId}/neighbors/update`,
...
export const fetchAllLocations = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const response = await axios.get('/locations/locations/lookup');
            return response.data;
        } catch (error) {
            return rejectWithValue(error.response?.data || error.message);
        }
...
export const deleteLocation = createAsyncThunk(
    ...
    async (locationId, { rejectWithValue }) => {
        try {
            ...
            await axios.delete(`/locations/${locationId}/delete`);
            return locationId;
        } catch (error) {
            return rejectWithValue(error.response?.data || error.message);
        }
...
export const removeNeighbor = createAsyncThunk(
  ...
  async ({ locationId, neighborId }, { rejectWithValue }) => {
    try {
      ...
      const url = `/locations/${locationId}/neighbors/${neighborId}`;
