...
const AdminLocationsPage = () => {
  ...
  const { countries, countryDetails, regionDetails, loading, error } =
    useSelector(selectAdminLocations);
  ...
  if (loading && !countries?.length)
    return <div className={s.loading}>Загрузка списка стран...</div>;
      ...
      <div className={s.locations_list}>
          ...
          <div key={country.id} className={s.country_container}>
            ...
            >
              ...
              <div className={s.header_controls}>
                ...
                <span
                  className={`${s.arrow} ${openedCountries[country.id] ? s.open : ""}`}
                >
                  ▼
                </span>
              </div>
                  ...
                  <div key={region.id}>
                    ...
                    >
                      ...
                      <div className={s.actions}>
                        ...
                        <span
                          className={`${s.arrow} ${openedRegions[region.id] ? s.open : ""}`}
                        >
                          ▼
                        </span>
                      </div>
                        ...
                        {regionDetails[region.id].districts?.map((district) => (
                          <div key={district.id}>
                            ...
                            >
                              ...
                              {district.image_url && (
                                <div>
                                  <img src={district.image_url} alt="" />
                                </div>
                              )}
                              ...
                              <div className={s.actions}>
                                ...
                                <button
                                  className={s.delete_button}
                                  onClick={(e) =>
                                    handleDeleteDistrict(e, district.id)
                                  }
                                >
                                  Удалить
                                </button>
                                <button
                                  ...
                                  onClick={(e) =>
                                    handleAddLocation(e, district.id)
                                  }
                                  type="button"
                                >
                                  Добавить локацию
                                ...
                                <span
                                  className={`${s.arrow} ${openedDistricts[district.id] ? s.open : ""}`}
                                >
                                  ▼
                                </span>
                              </div>
                            ...
                            {openedDistricts[district.id] && (
                              <div className={s.nested_container}>
                                {district.locations?.map((loc) =>
                                  renderLocationsRecursively(loc),
                                )}
                              </div>
                            )}
                          </div>
        ...
        {editingCountry && (
          <div
            ...
            onClick={(e) =>
              handleOverlayClick(e, () => setEditingCountry(null))
            }
          >
            <EditCountryForm
        ...
        {editingDistrict && (
          <div
            className={s.edit_form_container}
            onClick={(e) =>
              handleOverlayClick(e, () => setEditingDistrict(null))
            }
          >
            <EditDistrictForm
