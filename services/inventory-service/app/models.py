...
class CharacterInventory(Base):
    ...
    item_1 = Column(String, default="Basic Sword")  # Первый предмет
    item_2 = Column(String, default="Basic Shield")  # Второй предмет
    item_3 = Column(String, default="Health Potion")  # Третий предмет
